...
export const PartyAgedInvoicePDF = async (e, item, status, date_from, date_to, user, SectorFilter, sharpnessValue, OrderBy) => {
    ...
    doc.setFontSize(16).setTextColor(0, 0, 0).setFont('helvetica', 'bold').text("PARTY AGED INVOICES", x, 90, { align: "center" });
