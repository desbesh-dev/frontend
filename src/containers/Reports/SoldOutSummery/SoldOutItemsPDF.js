...
export const SoldOutItemsPDF = async (e, table, date_to, user) => {
    ...
    doc.setFontSize(15).setTextColor(0, 0, 0).setFont(undefined, 'bold').text("Product Sold Out Items", Left, 40)
    ...
    const fileName = `Product Sold Out Items ${dateRangeText}.pdf`
