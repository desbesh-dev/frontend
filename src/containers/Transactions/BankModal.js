...
export const AddBankModal = (props) => {
    ...
    const { AccName, ChequeNo, AccNumber, BankName, BankBranchName, BankID, Status } = formData;
            ...
            <Modal.Body>
                ...
                <div className="d-flex justify-content-center bg-white h-100">
                    <div className="row justify-content-center align-items-center">
                        <span className="fs-4 fw-bolder text-center px-0 text-uppercase">Bank Account</span>
                        ...
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    value={ChequeNo ? ChequeNo : ""}
                                    onChange={e => onChange(e)}
                                />
                                {Error.ChequeNo ?
                                    <p className='mx-auto d-table text-center text-warning m-0'><small>{Error.ChequeNo}</small></p>
                                    : null}
                            </div>
                        ...
                        <div className="d-flex justify-content-around">
                            ...
                            <button className="btn btn-outline-success fs-6 fw-bold text-center mx-2" onClick={() => AddBisBank()}><i class="fad fa-save pr-2"></i> Save </button>
                            <button className="btn btn-outline-success fs-6 fw-bold text-center mx-2" onClick={() => ActionClick()}><i class="fad fa-edit pr-2"></i> Done </button>
                        </div>
                    </div>
                </div>
            </Modal.Body>
