...
const RequisitionHistory = ({ display, SupplierID, CompanyID, BranchID, user, scale, sub_scale }) => {
                ...
                <div className="col-md-12 position-absolute overflow-auto mx-auto mt-3 w-100 bg-white" style={{ height: "80%" }}>
                    {
                        Array.isArray(Data) && Data.length ? Data.map((item, i) => (
                            <Link className="row bg-white m-0 border-bottom py-2 text-decoration-none" to={{
...
export default connect(mapStateToProps, { logout, load_user })(RequisitionHistory);