...
import { DispatchInvoiceDelete, FetchInvoice, RecallProduct } from '../../../../actions/ContractAPI';
...
import { DeleteModal, EditModal, InfoMessage } from "./Modals/ModalForm.js";
            ...
            <div className="container bg-white rounded">
                <div className="d-flex justify-content-between my-0 border-bottom py-2">
                    <div className='my-auto text-center'>
                        <p className='display-6 fw-bolder m-0 text-uppercase text-left'><Link className="fad fa-chevron-left px-2 text-dark text-decoration-none" to={`/sell_reports`}></Link> Dispatch Invoice</p>
                    </div>

                    <div className='text-center'>
                        <Link title="Generate PDF" className="btn fs-3 px-3 py-0 fad fa-file-pdf text-dark border-right" id="view"
                            // to={`/prv_dispatch_invoice/${item.InvoiceNo}`} 
                            to="#"
                        />
                        <Link title="Print" className="btn fs-3 px-3 py-0 fad fa-print text-dark border-right" id="view"
                            // to={`/prv_dispatch_invoice/${item.InvoiceNo}`} 
                            to="#"
                        />
                                ...
                                <div className='text-right'>
                                    {
                                        Data ?
                                            <div className="card-body p-0">
                                                <p className="fs-4 fw-bold m-0">{Data.BusinessID.Title}</p>
                                                <p className="text-muted m-0">{Data.BusinessID.Type + ", ID- " + Data.id}</p>
