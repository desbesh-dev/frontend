import {
  ...
  CreateAccount,
  RemoveUser,
  UpdateImage, colourStyles,
} from "../../../actions/APIHandler";
import {
  ...
  return (
    <div className="row h-100 w-100">
      <div className="col-sm-12 col-md-10 col-lg-10 mx-auto d-table h-100">
        <h1 className="pb-2">Register A New Business</h1>
        <div
        ...
        >
          ...
          <div className="tab-content" style={{ height: "auto" }}>
            ...
            >
              <div className="row">
                <div
                  className="col-lg-3 mx-auto d-table h-100 m-0 p-2"
                  style={{
                      ...
                      <div className="form-check mb-2">
                        <input
                          ...
                          onChange={(e) => {
                            setFormData({
                              ...formData,
                              [e.target.name]: !FarmRegCopy ? true : false,
                            });
                          }}
                        />
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={(e) => {
                            setFormData({
                              ...formData,
                              [e.target.name]: !is_staff ? true : false,
                            });
                          }}
                        />
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          onChange={(e) => {
                            setFormData({
                              ...formData,
                              [e.target.name]: !is_subscriber ? true : false,
                            });
                          }}
                        />
                        <label className="form-check-label" for="Subscriber">
                          Subscriber
                        </label>
                      </div>
                    </td>
...
export default connect(mapStateToProps, { logout })(CompanyRegister);
