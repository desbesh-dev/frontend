...
import { MoneyReciptPDF } from "../../../../../containers/Accounts/PaymentReceipt/MoneyReciptPDF";
                            ...
                            <table className={`table table-hover table-borderless bg-white text-nowrap`}>
                                <thead className='bg-white'>
                                    <tr className="text-center">
                                        ...
                                        <th className="py-1 border-center"><span>Receipt No</span></th>
