...
export const EmployeeActivity = (UserID, display, user, list, setList) => {
    ...
    const FetchUser = async (UserID) => {
        ...
        if (User_Data !== true) {
            ...
            setData(User_Data);
            setFormData({
                id: User_Data.data.UserInfo.id,
                FirstName: User_Data.data.UserInfo.FirstName,
                LastName: User_Data.data.UserInfo.LastName,
                email: User_Data.data.UserInfo.email,
                MobileNo: User_Data.data.UserInfo.MobileNo,
                UserType: User_Data.data.UserInfo.UserType,
                is_subscriber: User_Data.data.UserInfo.is_subscriber,
                is_staff: User_Data.data.UserInfo.is_staff,
                is_admin: User_Data.data.UserInfo.is_admin,
                is_block: User_Data.data.UserInfo.is_block,
                is_active: User_Data.data.UserInfo.is_active,

                FullName: User_Data.data.Details.FullName,
                Nid_BirthNo: User_Data.data.Details.Nid_BirthNo,
                DOB: User_Data.data.Details.DOB,
                FatherName: User_Data.data.Details.FatherName,
                MotherName: User_Data.data.Details.MotherName,
                HoldingNo: User_Data.data.Details.HoldingNo,
                WardNo: User_Data.data.Details.WardNo,
                VillageName: User_Data.data.Details.VillageName,
                Union: User_Data.data.Details.Union,
                PostalCode: User_Data.data.Details.PostalCode,
                Upazila: User_Data.data.Details.Upazila,
                Zila: User_Data.data.Details.Zila,
                Division: User_Data.data.Details.Division,
                ContactNo: User_Data.data.Details.ContactNo,
                Nationality: User_Data.data.Details.Nationality,
                Religion: User_Data.data.Details.Religion,
                Gender: User_Data.data.Details.Gender,
                Occupation: User_Data.data.Details.Occupation,
                EducationalQualification: User_Data.data.Details.EducationalQualification,
                Image: User_Data.data.Details.Image,
                ImagePrv: "",
                RefID: User_Data.data.Ref ? User_Data.data.Ref.RefID : "",
                RefName: User_Data.data.Ref ? User_Data.data.Ref.RefName : "",
                RepID: User_Data.data.Ref ? User_Data.data.Ref.RepID : "",
                RepName: User_Data.data.Ref ? User_Data.data.Ref.RepName : "",
                NIDCopy: User_Data.data.Ref ? User_Data.data.Ref.NIDCopy : "",
                Agreement: User_Data.data.Ref ? User_Data.data.Ref.Agreement : "",
                BankCheque: User_Data.data.Ref ? User_Data.data.Ref.BankCheque : "",
                FarmRegCopy: User_Data.data.Ref ? User_Data.data.Ref.FarmRegCopy : "",

                AccName: User_Data.data.Bank ? User_Data.data.Bank.AccName : "",
                AccNumber: User_Data.data.Bank ? User_Data.data.Bank.AccNumber : "",
                BankName: User_Data.data.Bank ? User_Data.data.Bank.BankName : "",
                BankBranchName: User_Data.data.Bank ? User_Data.data.Bank.BranchName : "",
                Address: User_Data.data.Bank ? User_Data.data.Bank.Address : "",
                Telephone: User_Data.data.Bank ? User_Data.data.Bank.Telephone : "",
                BankID: User_Data.data.Bank ? User_Data.data.Bank.BankID : "",
            });
    ...
    return (
        <div className="position-relative h-100">
            <div className="position-absolute overflow-auto mb-5 pb-5 w-100 h-75">
                <p className='display-6 d-flex justify-content-center mb-4'>Activity</p>
