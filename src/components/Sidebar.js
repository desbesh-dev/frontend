...
const Sidebar = ({ logout, scale, sub_scale, user, children, setNavBar, NavBar, isActive, setActive }) => {
  ...
  return (
    <nav id="sidebar" className={NavBar ? "sidebar toggled" : "sidebar"}>
      ...
      <Link className="d-flex sidebar-brand p-0 mt-2 w-auto" to="/">
        <img src={logo} className="img-fluid mx-auto d-table pt-2" width="210" height="100" alt="avatar" />
        {/* SoftaPoul */}
      </Link>
      <div className="sidebar-content">
        ...
        <ul className="sidebar-nav">
          ...
          {scale === 6 || (scale === 3 && (sub_scale === 7 || sub_scale === 8 || sub_scale === 9 || sub_scale === 10)) ?
            <Fragment>
              {/* Cash Flow */}
              <li className="sidebar-item" id="Transaction" onClick={(e) => setActive(1300)}>
                <Link className={isActive === 1300 ? "sidebar-link active" : "sidebar-link"} to='/transactions'>
                  <i class="fad fa-exchange text-center align-middle fs-4 me-0" style={{ minWidth: "30px" }}></i><span className="align-middle ml-2">Smart Transactions</span>
                </Link>
              </li>
          ...
          <li className="sidebar-item">
            ...
            <ul id="dashboards" className={isActive >= 100 && isActive < 199 ? "sidebar-dropdown list-unstyled collapse show" : "sidebar-dropdown list-unstyled collapse"} scale-bs-parent="#sidebar">
              {
                scale === 6 ?
                  <li className="sidebar-item" id="Farms" onClick={(e) => setActive(101)}>
                    <Link className={isActive === 101 ? "sidebar-link active" : "sidebar-link"} to='/control_board' >Control Board</Link>
                  </li> : null}
              ...
              </li>
              {
                scale === 6 || (scale === 3 && (sub_scale === 5 || sub_scale === 6 || sub_scale === 9 || sub_scale === 10)) ?
                  <Fragment>
                    <li className="sidebar-item" id="LiveStock" onClick={(e) => setActive(105)}>
                      <Link className={isActive === 105 ? "sidebar-link active" : "sidebar-link"} to='/live_stock' >Live Stock</Link>
                    </li>
                    <li className="sidebar-item" id="CostMaping" onClick={(e) => setActive(107)}>
                      <Link className={isActive === 107 ? "sidebar-link active" : "sidebar-link"} to='/cost_mapping' >Cost Mapping</Link>
                    </li>
                    <li className="sidebar-item" id="Monitoring" onClick={(e) => setActive(110)}>
                      <Link className={isActive === 110 ? "sidebar-link active" : "sidebar-link"} to='/goods_n_bird' >Goods & Bird</Link>
                    </li>
              ...
              {
                scale === 6 || (scale === 3 && (sub_scale === 5 || sub_scale === 6 || sub_scale === 7 || sub_scale === 9 || sub_scale === 10)) ?
                  <Fragment>
                    ...
                    <li className="sidebar-item" id="Monitoring" onClick={(e) => setActive(109)}>
                      <Link className={isActive === 109 ? "sidebar-link active" : "sidebar-link"} to='/recall_products' >Return</Link>
                    </li>
                  </Fragment>
                  : null
              }
          ...
          {/* Suppliers */}
          {scale === 6 || (scale === 3 && (sub_scale === 5 || sub_scale === 7 || sub_scale === 9 || sub_scale === 10)) ?
            <li className="sidebar-item">
              <a
                scale-bs-target="#dashboards" scale-bs-toggle="collapse"
              ...
              <ul id="Suppliers" className={isActive >= 300 && isActive < 399 ? "sidebar-dropdown list-unstyled collapse show" : "sidebar-dropdown list-unstyled collapse"} scale-bs-parent="#sidebar">
                ...
                <li className="sidebar-item">
                  <Link className={isActive === 302 ? "sidebar-link active" : "sidebar-link"} to='/my_supplier_list' id="MySuppliers" role='button' onClick={(e) => setActive(302)}>My Supplier & Vendors</Link>
                </li>

                {/* <li className="sidebar-item">
                  <Link className={isActive === 303 ? "sidebar-link active" : "sidebar-link"} to='/supplier_reg' id="LclSupplier" role='button' onClick={(e) => setActive(303)}>Local Supplier Register</Link>
                </li> */}

                {
                  scale === 6 || (scale === 3 && (sub_scale === 5 || sub_scale === 9 || sub_scale === 10)) ?
                    <li className="sidebar-item">
                      <Link className={isActive === 304 ? "sidebar-link active" : "sidebar-link"} to='/national_supplier_list' id="AllSuppliers" role='button' onClick={(e) => setActive(304)}>National Suppliers</Link>
                    </li>
                    : null
                }

                {
                  scale === 6 || (scale === 3 && (sub_scale === 5 || sub_scale === 7 || sub_scale === 9 || sub_scale === 10)) ?
                    <li className="sidebar-item">
                      <Link className={isActive === 301 ? "sidebar-link active" : "sidebar-link"} to='/supplier_reg' id="SupplierReg" role='button' onClick={(e) => setActive(301)}>Create New Vendor</Link>
                    </li>
                    : null
                }

                {/* <li className="sidebar-item">
                  <Link className={isActive === 305 ? "sidebar-link active" : "sidebar-link"} to='/create_branch' id="SplDashboard" role='button' onClick={(e) => setActive(305)}>Dashboard</Link>
                </li> */}
          ...
          <li className="sidebar-item">
            ...
            <ul id="Party" className={isActive >= 400 && isActive < 499 ? "sidebar-dropdown list-unstyled collapse show" : "sidebar-dropdown list-unstyled collapse"} scale-bs-parent="#sidebar">
              <li className="sidebar-item">
                <Link className={isActive === 401 ? "sidebar-link active" : "sidebar-link"} to='/party_reg' id="PartyReg" role='button' onClick={(e) => setActive(401)}>Add New Party</Link>
              </li>

              <li className={isActive === "MyParty" ? "sidebar-item active" : "sidebar-item"}>
                <Link className={isActive === 402 ? "sidebar-link active" : "sidebar-link"} to='/my_party_list' id="MyParty" role='button' onClick={(e) => setActive(402)}>My Party</Link>
              </li>

              <li className={isActive === "PartyDashboard" ? "sidebar-item active" : "sidebar-item"}>
                <Link className={isActive === 403 ? "sidebar-link active" : "sidebar-link"} to='#' id="PartyDashboard" role='button' onClick={(e) => setActive(403)}>Dashboard</Link>
              </li>
          ...
          <li className="sidebar-item">
            ...
            <ul id="Inventory" className={isActive >= 700 && isActive < 799 ? "sidebar-dropdown list-unstyled collapse show" : "sidebar-dropdown list-unstyled collapse"} scale-bs-parent="#sidebar">
              ...
              <li className="sidebar-item">
                <Link className={isActive === 703 ? "sidebar-link active" : "sidebar-link"} to={`${scale === 3 && (sub_scale === 2 || sub_scale === 3 || sub_scale === 4) ? '/sr_sell_reports' : '/sell_reports'}`} id="SellReports" role='button' onClick={(e) => setActive(703)}>Sell Report</Link>
              </li>

              <li className="sidebar-item">
                <Link className={isActive === 708 ? "sidebar-link active" : "sidebar-link"} to={`${scale === 3 && (sub_scale === 2 || sub_scale === 3 || sub_scale === 4) ? '/sr_sell_reports' : '/purchase_reports'}`} id="PurchaseReports" role='button' onClick={(e) => setActive(708)}>Purchase Report</Link>
              </li>
          ...
          {scale === 6 ?
            <Fragment>
              ...
              <li className="sidebar-item">
                ...
                <ul id="Inventory" className={isActive >= 1100 && isActive < 1199 ? "sidebar-dropdown list-unstyled collapse show" : "sidebar-dropdown list-unstyled collapse"} scale-bs-parent="#sidebar">
