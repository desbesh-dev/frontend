...
const SM_Sidebar = ({ logout, scale, sub_scale, user, children, setNavBar, NavBar, isActive, setActive }) => {
          ...
          <li className="sidebar-item">
            ...
            <ul id="dashboards" className={isActive >= 100 && isActive < 199 ? "sidebar-dropdown list-unstyled collapse show" : "sidebar-dropdown list-unstyled collapse"} scale-bs-parent="#sidebar">
              ...
              {/* <li className="sidebar-item" id="Farms" onClick={(e) => setActive(101)}>
                <Link className={isActive === 101 ? "sidebar-link active" : "sidebar-link"} to='/dashboard' >Farms</Link>
              </li> */}
              ...
              {/* <li className="sidebar-item" id="Assesment" onClick={(e) => setActive(107)}>
                <Link className={isActive === 107 ? "sidebar-link active" : "sidebar-link"} to='/dashboard' >Assesment</Link>
              </li> */}

              {/* <li className="sidebar-item" id="FarmerReg" onClick={(e) => setActive(104)}>
                <Link className={isActive === 104 ? "sidebar-link active" : "sidebar-link"} to='/dashboard' >Farmer Registration</Link>
              </li> */}
            </ul>
          </li>
          ...
          {scale === 6 || (scale === 3 && (sub_scale === 5 || sub_scale === 7 || sub_scale === 9 || sub_scale === 10)) ?
            <li className="sidebar-item">
              ...
              <ul id="Suppliers" className={isActive >= 300 && isActive < 399 ? "sidebar-dropdown list-unstyled collapse show" : "sidebar-dropdown list-unstyled collapse"} scale-bs-parent="#sidebar">
                ...
                <li className="sidebar-item">
                  <Link className={isActive === 302 ? "sidebar-link active" : "sidebar-link"} to='/my_supplier_list' id="MySuppliers" role='button' onClick={(e) => setActive(302)}>My Suppliers</Link>
                </li>
...

                {
                  scale === 6 || (scale === 3 && (sub_scale === 5 || sub_scale === 7 || sub_scale === 9 || sub_scale === 10)) ?
                    <li className="sidebar-item">
                      <Link className={isActive === 301 ? "sidebar-link active" : "sidebar-link"} to='/supplier_reg' id="SupplierReg" role='button' onClick={(e) => setActive(301)}>Add New Supplier</Link>
                    </li>
                    : null
                }
...
export default connect(mapStateToProps, { logout })(SM_Sidebar);
